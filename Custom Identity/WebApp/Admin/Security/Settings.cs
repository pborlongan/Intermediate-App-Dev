...
// Using a class with static members makes the code a little shorter to read and write. We can just say AppSettings[] instead of ConfigurationManager.AppSettings[]
...
{
    /// <summary>
    /// A collection of application-wide settings that provide values for security roles which have been set in the web.config's <appsettings /> section
    /// </summary>
    internal static class Settings // There is no need to instantiate this
    {
        ...
        public static IEnumerable<string> DefaultSecurityRoles => new List<string>
        { AdminRole, UserRole };
        #endregion
